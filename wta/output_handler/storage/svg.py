...
class TsLabelsSvg(Svg):
    def __init__(self, texthis, senhis):
        self.plot = self.preprocess_data(texthis, senhis)
        self.filepath = os.path.join(
            paths.stats_dir, f"{settings.filename}_ts_labels_stats.svg"
        )
...
class TsTokensSvg(Svg):
    def __init__(self, texthis, senhis):
        self.plot = self.preprocess_data(texthis, senhis)
        self.filepath = os.path.join(
            paths.stats_dir, f"{settings.filename}_ts_tokens_stats.svg"
        )
...
class DeletionsSvg(Svg):
    def __init__(self, texthis, senhis):
        self.plot = self.preprocess_data(texthis, senhis)
        self.filepath = os.path.join(
            paths.stats_dir, f"{settings.filename}_deletions_stats.svg"
        )
...
class InsertionsSvg(Svg):
    def __init__(self, texthis, senhis):
        self.plot = self.preprocess_data(texthis, senhis)
        self.filepath = os.path.join(
            paths.stats_dir, f"{settings.filename}_insertions_stats.svg"
        )
